...
DATASET_VERSION = "images_kepler_style"
...
plt.tight_layout()
#salvamos la figura
plt.savefig(REPORT_DIR/f"confusion_matrix_{DATASET_VERSION}.png")
print("Figura de las predicciones salvada")

#salvamos el modelo
torch.save(model.state_dict(), MODEL_DIR / f"resnet18_exoplanetas_{DATASET_VERSION}.pt")
